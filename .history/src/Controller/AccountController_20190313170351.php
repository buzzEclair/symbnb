...
class AccountController extends AbstractController
{
     ...
     * @return Response
     */
    public function bookingsComment(Booking $booking, Request $request, ObjectManager $manager, Comment $commentBase){
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if($commentBase->getAuthor() === $booking->getBooker() && $commentBase->getAd() === $booking->getAd()){
                $this->addFlash(
                    'warning',
                    "Vous ne pouvez laisser qu'un commentaire"
                );
            }else{
